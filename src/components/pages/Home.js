...
const Home = () => {
    return (
        <div>
            <section className="bg-gradient-to-r from-indigo-900 to-red-900 text-white py-10 flex flex-col items-center justify-center text-center">
            ...
            <section className='py-10 bg-gradient-to-r from-purple-600 via-violet-600 to-pink-600'>
                <div className='container mx-auto px-4'>
                    <div className='col-md-12 text-center'>
                        <h3 className='text-2xl font-bold text-gray-300'>What is this?</h3>
                        <div className='h-1 w-48 my-2.5 mx-auto bg-gradient-to-r from-cyan-600 via-gray-400 to-cyan-600'></div>
            ...
            <section className='py-10 bg-gradient-to-r from-cyan-400 via-gray-500 to-blue-600'>
            ...
            <section className='py-10 bg-gradient-to-r from-red-500 via-purple-500 to-blue-500'>
                ...
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                    <div className='card shadow-lg'>
                        <img src={Topic1} className='w-full' />
                    ...
                    <div className='card shadow-lg'>
                        <img src={Topic2} className='w-full' />
                        <div className='card-body flex flex-col justify-center items-center text-center h-full p-4'>
                            <h6 className='text-xl'>Cristiano Ronaldo</h6>
                            <p className='text-base'>Cristiano Ronaldo dos Santos Aveiro is a Portuguese professional footballer who plays as a forward for and captains both Saudi Pro League club Al-Nassr and the Portugal national team.</p>
                            <button className='btn bg-gradient-to-r from-pink-500 via-violet-500 to-pink-500 text-white no-underline hover:from-indigo-500 hover:via-red-500 hover:to-indigo-500'>Read More</button>
                        </div>
                    </div>

                    <div className='card shadow-lg'>
                        <img src={Topic3} className='w-full' />
                        <div className='card-body flex flex-col justify-center items-center text-center h-full p-4'>
                            <h6 className='text-xl'>X-Men</h6>
                            <p className='text-base'>The X-Men is a team from Marvel comics that is known for their mutant abilities. All of the members have mutant abilities that make them different from normal humans.</p>
                            <button className='btn bg-gradient-to-r from-gray-500 via-blue-500 to-gray-500 text-white no-underline hover:from-purple-500 hover:via-cyan-400 hover:to-purple-500'>Read More</button>
                        </div>
                    </div>

                    <div className='card shadow-lg'>
                        <img src={Topic4} className='w-full' />
                        <div className='card-body flex flex-col justify-center items-center text-center h-full p-4'>
                            <h6 className='text-xl'>The Hulk</h6>
                            <p className='text-base'>The Hulk is a character from Marvel comics that is a member of Avengers. His real name is Bruce Banners and he is the strongest member of Avengers.</p>
                            <button className='btn bg-gradient-to-r from-green-500 via-lime-500 to-green-500 text-white no-underline hover:from-blue-500 hover:via-green-500 hover:to-blue-500'>Read More</button>
                        </div>
                    </div>
                </div>
            </section>
